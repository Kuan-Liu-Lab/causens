...
#' @param form Form of the sensitivity function (character: "increasing" or "decreasing")
#' @return Sensitivity of treatment effect estimate to unmeasured confounding (numeric)
#' 
#' sf(z, e, form)
#' @export
